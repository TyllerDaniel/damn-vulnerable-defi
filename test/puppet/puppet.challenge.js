...
describe('[Challenge] Puppet', function () {
    ...
    it('Exploit', async function () {
        ...
        //connect to the contracts with the attacker wallet.
        ...
        //Function to get the current token/eth balances.
